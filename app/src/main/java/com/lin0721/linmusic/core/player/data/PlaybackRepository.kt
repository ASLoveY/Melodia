...
data class ResolvedAudioSource(val url: String, val fingerprint: String = "")
...
interface PlaybackRepository {
    ...
    fun resolveSong(songId: Long): Flow<Result<ResolvedAudioSource>> = getSongUrl(songId).map { result -> result.map { ResolvedAudioSource(it) } }
