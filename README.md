...
正式版 **v1.7.0** 纳入 Hi-Res 输出，修复相似歌曲漫游队列，并支持根据本地背景图和深浅主题自动生成按钮配色。每日推荐已确认是个性化服务设置导致的空结果，恢复设置后通过真实账号读取与播放验证。[正式版验收记录](docs/V1_7_0_VALIDATION.md) · [Hi-Res 实现与适用范围](docs/NATIVE_DIRECT_OUTPUT.md)。
